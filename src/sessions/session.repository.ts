...
export class SessionRepository {
     ...
     */
    async update(where: Prisma.SessionWhereUniqueInput, data: Prisma.SessionUpdateInput): Promise<Session> {
    ...
    async aggregate(
        ...
        aggregate: Omit<Parameters<typeof this.prisma.session.aggregate>[0], 'where'>
