...
export class MemoryMonitorTask {
  ...
  handleMemoryMonitoring() {
    this.logger.log(
      '🔄 Scheduled memory monitoring check',
      'MemoryMonitorTask.handleMemoryMonitoring',
    );
  ...
  handleGarbageCollection() {
    this.logger.log(
      ...
      'MemoryMonitorTask.handleGarbageCollection',
    );
  ...
  handleDetailedMemoryReport() {
    this.logger.log(
      ...
      'MemoryMonitorTask.handleDetailedMemoryReport',
    );
    this.memoryMonitor.logDetailedMemoryInfo();
    ...
    this.logger.log(
      `📈 Memory Trends: ${JSON.stringify(message)}`,
      'MemoryMonitorTask.handleDetailedMemoryReport',
    );
  }
